...
#
######################################################
def real_dis_affect(col,col2,power = 1, upper = 500, exp = False):
    lon1, lat1 = col
    lon2, lat2 = col2
    R = 6373.0
    dlon = lon2 - lon1
    ...
    if exp:
        return np.exp(-(1.0*dis/upper)**power)
...
if __name__ == '__main__':
    ...
    uppers = [25]
    powers = [0]
    mps_generater(uppers, powers)
    sys.exit("**************finished generating models**************")
