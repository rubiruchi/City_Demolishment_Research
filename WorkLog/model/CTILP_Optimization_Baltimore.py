################################################################################
#
# Module: CTILP_Optimization_Baltimore.py
...
class OSMNX_Map(object):
    def __init__(self, address='1516 Kenhill Ave, Baltimore, MD', radius=80, same = False, Baltimore = False):
